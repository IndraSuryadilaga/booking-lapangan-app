                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900">{{ $totalBookingsToday }}</h3>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900">{{ $pendingPayments }}</h3>
                        </div>
                    </div>

                    <!-- Lapangan Sedang Dipakai -->
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900">{{ $liveOccupancy }} Lapangan</h3>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-neutral-900">Rp {{ number_format($monthlyRevenue, 0, ',', '.') }}</h3>
                        </div>
                    </div>
                </div>

                <!-- Schedule Table & Trend Chart -->
